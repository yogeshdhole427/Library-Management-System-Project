...
public class DeleteMember extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e1)
	{
		...
		if(e1.getSource()==b1)
		{
			...
			rs1=stmt1.executeQuery("select * from student where s_rollno='"+Id+"' and s_class='"+s2+"'");
			
			if(rs1.next())
			{
				
				t3.setText(""+rs1.getString(1));
				t4.setText(""+rs1.getString(2));
				t5.setText(""+rs1.getInt(3));
				t6.setText(""+rs1.getInt(5));
				t7.setText(""+rs1.getString(6));
		...
		if(e1.getSource()==b2)
		{
			...
			n=stmt2.executeUpdate("delete  from student where s_rollno='"+Id+"' and s_class='"+s2+"'");
